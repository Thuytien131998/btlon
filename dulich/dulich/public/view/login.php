...
<div class="container-fluid">
  <div class="hearder">
     ...
     <div class="row">
      ...
      <div class="col-sm-0">
                    <a class="dangki" href="http://localhost:8080/tlu/dulich/public/view/register.php">Đăng kí</a>
                  </div>
     </div>
  </div>
</div>
<div class="content">
  <form>
    <h1>Đăng nhập</h1>
    <input class="t" placeholder="username" type="text" required="">
    <input  class="t" placeholder="password" type="password" required="">
    <button class="t">Đăng nhập</button>
</div>
<div class="footer">
    <div class="container">
      <div class="col-sm-5">
